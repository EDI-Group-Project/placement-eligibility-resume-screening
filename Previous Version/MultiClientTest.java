 ...
 *   2. Compile: javac -d out -cp src src/com/placement/*/.java test/MultiClientTest.java
 *   3. Run: java -cp out MultiClientTest
...
public class MultiClientTest {
    ...
    // TODO: replace with a real, seeded test account for your DB.
    private static final String TEST_ROLE = "TPC";
    private static final String TEST_EMAIL = "tpc.test@placement.com";
